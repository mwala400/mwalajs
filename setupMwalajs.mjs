...
async function setupMwalajs() {
    ...
    try {
        ...
        console.log("📦 Installing 'express' inside 'mwalajs'...");
        ...
        if (fs.existsSync(targetMwalajs)) {
            console.log("🗑️ Removing old 'mwalajs' from node_modules...");
        ...
        console.log(`✅ Successfully installed 'express' and moved 'mwalajs' to:`);
